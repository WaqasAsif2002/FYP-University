...
export default function EasyPaisaPayment({ amount, onPaymentComplete, onCancel }) {
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-700 mb-6">
          <div className="text-center">
            <p className="text-sm text-green-700 dark:text-green-300 mb-1">Amount to Pay</p>
            <p className="text-3xl font-bold text-green-600 dark:text-green-400">Rs. {amount}</p>
          </div>
        </div>
        ...
        {/* QR Code - Using the provided image */}
        <div className="text-center mb-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 inline-block">
            <img src="/images/easypaisa-qr.png" alt="EasyPaisa Payment QR Code" className="w-48 h-auto mx-auto" />
          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700 mb-6">
          ...
          <ol className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <li>
              2. Send Rs. {amount} to {EASYPAISA_NUMBER}
            </li>
